...
COMPARABLE_GROUPS = {
    ...
    "Normalista": "Universitaria o superior",
    "Tecnica profesional": "Universitaria o superior",
    "Tecnologica": "Universitaria o superior",
    "Universitaria": "Universitaria o superior",
    "Especializacion": "Universitaria o superior",
    "Maestria": "Universitaria o superior",
    "Doctorado": "Universitaria o superior",
}
    ...
    text = "\n".join(
        [
            ...
            *monthly_rows,
            r"\bottomrule",
            r"\end{tabular}",
            r"\caption*{\footnotesize Nota: remuneración mensual en millones de pesos mensuales de 2025 por trabajador. El crecimiento es anualizado para 2021--2025. Cálculos con microdatos mensuales de la GEIH marco 2018. Fuente: cálculos propios con GEIH del DANE.}",
            r"\end{table}",
            "",
            r"\begin{table}[H]",
            r"\centering",
            ...
            *hourly_rows,
            r"\bottomrule",
            r"\end{tabular}",
            r"\caption*{\footnotesize Nota: remuneración por hora en miles de pesos de 2025 por hora trabajada. El crecimiento es anualizado para 2021--2025. Cálculos con microdatos mensuales de la GEIH marco 2018. Fuente: cálculos propios con GEIH del DANE.}",
            r"\end{table}",
            "",
        ]
    )
