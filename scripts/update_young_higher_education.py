...
def write_table(series: pd.DataFrame) -> None:
    ...
    lines = [
        r"\begin{table}[H]",
        r"\centering",
        r"\caption{Remuneración laboral de ocupados de 25 a 29 años con educación superior, 2010 y 2025}",
        ...
        (
            ...
            r"de 25 a 29 años que reportan educación superior. "
...
def draw_series(series: pd.DataFrame) -> None:
    ...
    draw_text(draw, (85, 50), "Remuneración laboral: 25 a 29 años con educación superior", "#111111", 38, True)
