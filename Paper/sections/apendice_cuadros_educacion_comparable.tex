...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth]{Paper/figures/fig_kernel_remuneracion_cine11_2010_2025.png}
  \caption{Distribución de la remuneración laboral por logro educativo, 2010 y 2025}
  \label{fig:remuneracion_educacion_kernels_siete}
  \caption*{\footnotesize Nota: cada fila corresponde a uno de los siete logros educativos armonizados. La columna izquierda muestra la remuneración mensual por trabajador en millones de pesos de 2025. La columna derecha muestra la remuneración por hora trabajada en miles de pesos de 2025. Las distribuciones se estiman con factores de expansión sobre el log de la remuneración. El eje horizontal está en escala logarítmica. El SMLMV no incluye auxilio de transporte. Fuente: cálculos propios con GEIH del DANE y decretos del Gobierno nacional para SMLMV.}
\end{figure}
...
\input{Paper/sections/tasas_laborales_educacion_cinco_table}
...
\begin{figure}[H]
  ...
  \caption*{\footnotesize Nota: El eje horizontal está en escala logarítmica. La remuneración mensual por trabajador está en millones de pesos de 2025 y la remuneración por hora trabajada en miles de pesos de 2025. Fuente: cálculos propios con GEIH del DANE.}
\end{figure}

\input{Paper/sections/descomposicion_remuneracion_educacion_detalle_table}
