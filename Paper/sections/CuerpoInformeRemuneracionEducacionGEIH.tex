...
\textbf{El objetivo de este informe es medir cómo ha evolucionado la remuneración laboral por logro educativo entre 2010 y 2025.} Con este fin se clasifican las personas ocupadas según una clasificación homogénea construida a partir de la Gran Encuesta Integrada de Hogares (GEIH). Esta clasificación permite distinguir siete logros educativos comparables durante todo el periodo: ninguno, básica primaria, básica secundaria, educación media, formación técnica o tecnológica, pregrado universitario y posgrado. Para cada logro se estudia la evolución de la remuneración mensual por trabajador y la remuneración por hora trabajada.
...
\textbf{El informe está organizado en cinco secciones, incluyendo esta introducción, además del apéndice.} La Sección \ref{sec:metodologia} describe las medidas de remuneración laboral, la clasificación usada en la serie larga y la descomposición del crecimiento de la remuneración entre el mayor logro educativo de la población ocupada y la remuneración de cada logro educativo. La Sección \ref{sec:grupos_comparables} presenta la dinámica de la remuneración entre 2010 y 2025 para los logros educativos comparables. La Sección \ref{sec:categorias_detalladas} aprovecha la apertura de la pregunta educativa desde 2021 para mirar la evolución reciente de credenciales más desagregadas. Finalmente, la Sección \ref{sec:conclusiones} resume los retos de la educación dentro de la agenda nacional de productividad.

\section{Metodología}\label{sec:metodologia}

\subsection{Fuente, periodo y clasificación educativa}

\textbf{El informe calcula la remuneración laboral a partir de la Gran Encuesta Integrada de Hogares (GEIH) para 2010--2025, excluyendo 2020.} El año 2020 se excluye por el choque de la pandemia y por las dificultades de comparación que generó ese año en la encuesta. A partir de los ingresos laborales devengados el último mes y las horas trabajadas la última semana se construyen dos medidas: la remuneración mensual por trabajador y la remuneración por hora trabajada. Ambas se expresan en pesos constantes de 2025. 

\textbf{La pregunta de logro educativo cambió en 2021.} Antes de 2021, la encuesta ofrecía seis respuestas válidas sobre el mayor nivel educativo alcanzado: ninguno, preescolar, básica primaria, básica secundaria, media y superior o universitaria. Desde 2021, la encuesta conserva las primeras cuatro respuestas, separa media en media académica y media técnica, y desagrega el tramo posterior a la media en normalista, técnica profesional, tecnológica, universitaria, especialización, maestría y doctorado.

\textbf{Para construir una serie comparable, el informe usa una clasificación homogénea disponible para todo el periodo.} Esta clasificación no depende solo de la respuesta gruesa de nivel educativo. También usa el último grado o semestre aprobado y la información de título o diploma cuando está disponible. Por eso permite distinguir formación técnica o tecnológica, pregrado universitario y posgrado antes de 2021, aunque la respuesta original agrupaba esos niveles como superior o universitaria. También puede asignar a una persona al logro inmediatamente anterior cuando reporta haber cursado un nivel, pero no haber completado el ciclo correspondiente. El Cuadro \ref{tab:mapeo_logros_educativos} resume la correspondencia usada en la serie larga.
...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{3.8cm}>{\raggedright\arraybackslash}p{4.6cm}>{\raggedright\arraybackslash}p{4.6cm}@{}}
\toprule
Logro educativo en la serie larga & Información usada antes de 2021 & Información usada desde 2021 \\
\midrule
Ninguno & Ninguno, preescolar o primaria sin completar el ciclo & Ninguno, preescolar o primaria sin completar el ciclo \\
Básica primaria & Primaria completa o secundaria sin completar el ciclo & Primaria completa o secundaria sin completar el ciclo \\
Básica secundaria & Secundaria completa o media sin completar el ciclo & Secundaria completa o media sin completar el ciclo \\
Educación media & Media completa o educación superior sin título posterior a media & Media académica, media técnica, normalista o educación superior sin título posterior a media \\
Técnico o tecnológico & Superior o universitaria con título técnico o tecnológico & Técnica profesional o tecnológica \\
Pregrado universitario & Superior o universitaria con título universitario & Universitaria \\
Posgrado & Superior o universitaria con título de posgrado & Especialización, maestría o doctorado \\
No determinado & No sabe, no informa o información insuficiente & No sabe, no informa o información insuficiente \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Nota: pregrado universitario identifica a quienes alcanzaron educación universitaria sin posgrado. La serie de remuneración excluye el grupo no determinado. Fuente: cálculos propios con GEIH del DANE.}
\end{table}

\subsection{Descomposición del crecimiento de la remuneración}

\textbf{El crecimiento de la remuneración promedio puede descomponerse en dos componentes.} La remuneración promedio de la población ocupada puede escribirse como un promedio ponderado de la remuneración de cada logro educativo. Sea \(g\) uno de los logros educativos usados en los cuadros de remuneración, \(r_{g,t}\) la remuneración del grupo \(g\) en el año \(t\), y \(s_{g,t}\) su peso relativo. Tanto la remuneración por trabajador como la remuneración por hora trabajada se pueden escribir como:
...
\textbf{La remuneración promedio aumenta con el logro educativo, pero no creció rápido dentro de cada logro.} En 2025, la remuneración mensual por trabajador fue de 900 mil pesos entre quienes no reportaron ningún logro educativo, 1,5 millones en educación media, 1,9 millones en formación técnica o tecnológica, 3,5 millones en pregrado universitario y 6,9 millones en posgrado. La remuneración por hora conserva el mismo orden: 5,0 mil pesos para ninguno, 7,5 mil en educación media, 9,8 mil en formación técnica o tecnológica, 18,9 mil en pregrado universitario y 37,6 mil en posgrado.

\textbf{El total creció más rápido que la remuneración de cada logro educativo porque cambió la composición de la población ocupada.} La remuneración mensual por trabajador del total pasó de 1,5 a 1,9 millones de pesos, con crecimiento anual de 1,6\%. Dentro de los logros educativos, el crecimiento mensual fue menor: ninguno, básica primaria y básica secundaria crecieron alrededor de 0,6\% o 0,7\% anual, educación media creció 0,4\%, formación técnica o tecnológica cayó 0,1\%, pregrado universitario cayó 0,6\% y posgrado se mantuvo prácticamente estable. La remuneración por hora del total creció 2,0\% anual, también por encima del crecimiento observado dentro de cada logro educativo.
