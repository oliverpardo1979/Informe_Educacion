...
Pregrado universitario o posgrado & Pregrado universitario \\
Pregrado universitario o posgrado & Especialización \\
Pregrado universitario o posgrado & Maestría \\
Pregrado universitario o posgrado & Doctorado \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Nota: las respuestas no sabe o no informa se tratan como no determinadas y se excluyen de la serie de remuneración. Fuente: cálculos propios con GEIH del DANE.}
\end{table}
