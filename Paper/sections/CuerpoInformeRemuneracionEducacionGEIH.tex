...
\begin{figure}[H]
  ...
  \caption*{\footnotesize Nota: distribuciones estimadas con factores de expansión sobre el log de la remuneración. El eje horizontal está en escala logarítmica. La remuneración mensual equivalente se calcula como ingreso por hora multiplicado por horas semanales y 52/12. El grupo aproxima a los recién egresados porque la GEIH no identifica el año de graduación. El SMLMV no incluye auxilio de transporte. Fuente: cálculos propios con GEIH del DANE y decretos del Gobierno nacional para SMLMV.}
\end{figure}
...
\textbf{Desde 2021, la pregunta educativa permite distinguir credenciales más específicas que las usadas en la serie larga.} Esta apertura complementa la lectura de largo plazo de la sección anterior. En particular, desde 2021 se puede medir la remuneración para quienes alcanzan media académica, media técnica, formación normalista, técnica profesional, tecnológica, pregrado universitario, especialización, maestría y doctorado. %La correspondencia entre estas categorías y el sistema educativo se presenta en el Cuadro \ref{tab:mapeo_logros_educativos}.
...
\textbf{La mirada a la remuneración de jóvenes con título universitario puede ayudar a profundizar en las razones del estancamiento del pregrado universitario.} El Cuadro \ref{tab:remuneracion_pregrado_universitario_25_29} %y la Figura \ref{fig:kernel_pregrado_universitario_25_29}
...
\textbf{La agenda de productividad del país debe sostener los aumentos en el logro educativo de la población ocupada, pero también acelerar la productividad laboral de cada logro.} El país debe sostener el aumento del logro educativo de la población ocupada. Pero también debe lograr que ese mayor logro educativo se traduzca en mayor productividad y mejor remuneración, especialmente para quienes cuentan con pregrado universitario. Si la remuneración del pregrado universitario permanece estancada, estudiar más seguirá siendo una vía para acceder a mejores empleos, pero muchos egresados pueden encontrar que su esfuerzo educativo no les permite obtener mejores condiciones de vida frente a egresados de generaciones anteriores.
