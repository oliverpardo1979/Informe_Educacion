...
\textbf{Las brechas en la remuneración son aún más pronunciadas cuando se desagrega el logro educativo. El Cuadro \ref{tab:remuneracion_educacion_detallada_trabajador} presenta la evolución reciente de la remuneración por trabajador mientas el cuadro... presenta la evolución reciente de la remuneración por hora.  En 2025, la remuneración mensual promedio va de 740 mil pesos para preescolar o ninguno a 9,3 millones de pesos mensuales de 2025 para doctorado. La educación universitaria registró 3,1 millones.
