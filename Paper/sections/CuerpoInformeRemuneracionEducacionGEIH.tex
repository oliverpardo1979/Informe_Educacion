...
\textbf{La evolución anual de la remuneración de cada logro se presenta en el apéndice.} La Figura \ref{fig:remuneracion_educacion_series_comparables} muestra las trayectoria para la remuneración por trabajador y para la remuneración por hora de cada logro educativo. La recuperación reciente en la remuneración de quienes no alcanzan la educación superior podría estar asociada con los aumentos recientes del salario mínimo real, aunque la evaluación de esta hipótesis esta por fuera del alcance de este informe. En todo caso, las tendencias de largo plazo confirman el relativo estancamiento en la remuneración a través de distintos logros educativos.
