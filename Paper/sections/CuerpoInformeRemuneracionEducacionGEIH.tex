...
\textbf{Las distribuciones de remuneración se volvieron menos dispersas y más concentradas alrededor del salario mínimo.} La Figura \ref{fig:remuneracion_educacion_kernels}, incluida en el apéndice, compara los kernels de remuneración mensual y por hora en 2010 y 2025. En los tres logros educativos, la razón entre el percentil 90 y el percentil 10 disminuyó en ambas medidas de remuneración. También aumentó la proporción de ocupados con remuneración mensual equivalente cercana al salario mínimo. El Cuadro \ref{tab:masa_smlmv_educacion}, incluido en el apéndice, define esa masa como la proporción de ocupados entre 0,9 y 1,1 salarios mínimos del año y muestra que aumentó en los tres logros educativos.

\textbf{La trayectoria anual sugiere un crecimiento lento de la remuneración por trabajador y una recuperación reciente de la remuneración por hora.} La Figura \ref{fig:remuneracion_educacion_series_comparables}, incluida en el apéndice, muestra que la remuneración mensual por trabajador cambió poco dentro de cada logro educativo durante buena parte del periodo. En cambio, la remuneración por hora muestra una recuperación reciente, especialmente después de la pandemia. Esta recuperación coincide con aumentos importantes del salario mínimo real, aunque evaluar esa relación escapa al alcance de este informe.
