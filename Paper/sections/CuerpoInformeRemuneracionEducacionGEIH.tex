...
\subsection{Resultados laborales complementarios}\label{subsec:resultados_complementarios}
...
\textbf{Las distribuciones de remuneración se volvieron menos dispersas y más concentradas alrededor del salario mínimo.} La Figura \ref{fig:remuneracion_educacion_kernels}, incluida en el apéndice, compara la distribución de la remuneración mensual y por hora en 2010 y 2025. El Cuadro \ref{tab:estadisticos_remuneracion_educacion} reporta las estadísticas descriptivas de esas mismas remuneraciones. En los tres logros educativos disminuyó la razón entre los percentiles 90 y 10, y también cayó la desviación estándar. Al mismo tiempo, aumentó la proporción de ocupados con remuneración mensual equivalente cercana al salario mínimo. El Cuadro \ref{tab:masa_smlmv_educacion}, incluido en el apéndice, define esa masa como la proporción de ocupados entre 0,9 y 1,1 salarios mínimos del año y muestra que aumentó en los tres logros educativos.

\textbf{La trayectoria anual combina estabilidad hasta 2019 y un repunte posterior, más visible en la remuneración por hora.} La Figura \ref{fig:remuneracion_educacion_series_comparables}, incluida en el apéndice, muestra que la remuneración mensual por trabajador se mantuvo cerca de su nivel inicial en primaria o menos y secundaria o media hasta 2019, mientras cayó en educación superior antes de recuperarse. Después de 2019, la remuneración aumenta en los tres logros educativos. La remuneración por hora muestra un patrón similar, con un repunte reciente más marcado. Ese repunte coincide con aumentos importantes del salario mínimo real, aunque la figura no permite establecer si esa coincidencia explica el cambio observado.
