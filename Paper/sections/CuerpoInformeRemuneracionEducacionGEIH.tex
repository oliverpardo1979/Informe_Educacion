...
\textbf{Un corte de jóvenes con título universitario ayuda a precisar la pregunta sobre el estancamiento de la remuneración universitaria.} El Cuadro \ref{tab:remuneracion_pregrado_universitario_25_29} y la Figura \ref{fig:kernel_pregrado_universitario_25_29} restringen la muestra a ocupados de 25 a 29 años que reportan pregrado universitario y título universitario en 2021 y 2025. En este grupo, la remuneración mensual promedio cayó de 3,1 a 2,8 millones de pesos, mientras la mediana se mantuvo en 2,5 millones. La remuneración por hora promedio cayó de 16,4 a 15,6 mil pesos, aunque la mediana aumentó de 11,8 a 13,0 mil pesos. La distribución también se volvió menos dispersa y aumentó la proporción de ocupados con remuneración mensual cercana al salario mínimo. Este corte no identifica las causas del estancamiento, pero ayuda a formular una pregunta más concreta: en qué ocupaciones, sectores y condiciones de formalidad están entrando los jóvenes con título universitario, y cómo varía esa entrada según campo de estudio y tipo de programa.
...
\begin{figure}[H]
  ...
  \caption*{\footnotesize Nota: distribuciones estimadas con factores de expansión sobre el log de la remuneración. Se exige que \texttt{P3042} reporte educación universitaria, \texttt{P3043} reporte título universitario y la edad esté entre 25 y 29 años. El eje horizontal está en escala logarítmica. El SMLMV no incluye auxilio de transporte. Fuente: cálculos propios con microdatos mensuales de la GEIH marco 2018 del DANE.}
\end{figure}
...
\textbf{El lento crecimiento de La remuneración de quienes alcanzan un educación superior o universitaria es una señal de alerta.} La desagregación de la remuneración por logro educativo revela que quienes tienen maestría, doctorado,  formación técnica o técnológica han presentado aumentos reales en su remuneración desde 2021 hasta 2025. Este no es el caso de quienes logran alcanzar pregrado o especialización. El relativo estancamiento de la remuneración de quienes alcanzan el pregrado como máximo logro educativo debe ser objeto de futuras investigaciones.
