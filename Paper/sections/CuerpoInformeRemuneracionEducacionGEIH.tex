...
\textbf{La distribución de la remuneración entre credenciales de educación superior se presenta en el apéndice.} La Figura \ref{fig:kernel_remuneracion_credenciales_superiores} compara 2021 y 2025 para educación universitaria, especialización y maestría, tanto en remuneración mensual por trabajador como en remuneración por hora. En educación universitaria, los paneles mensuales muestran una concentración de ocupados cerca del salario mínimo y otra alrededor de la moda principal. No es una bimodalidad clara, pero sí un hombro de la distribución. Esa forma es compatible con diferencias en la calidad o pertinencia de la formación, aunque la figura por sí sola no permite separarlas de diferencias en ocupación, experiencia o formalidad.
