...
\textbf{El Cuadro \ref{tab:ocupacion_educacion_detallada} muestra la composición reciente del empleo con la pregunta abierta.} En 2025, media académica fue la categoría más grande, con 7,3 millones de ocupados y 31,8\% del empleo con remuneración válida. Le siguieron básica primaria, con 4,2 millones y 18,1\%, y universitaria, con 3,5 millones y 15,1\%. Entre 2021 y 2025, básica primaria perdió 2,7 p.p. y universitaria ganó 1,3 p.p. La transición educativa continúa, pero no elimina el peso de los logros medios en el empleo.
