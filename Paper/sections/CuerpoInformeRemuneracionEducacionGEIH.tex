...
\textbf{El objetivo de este informe es medir cómo ha evolucionado la remuneración laboral por logro educativo entre 2010 y 2025.} Con este fin se clasifican las personas ocupadas según una variable homogénea CINE 11 construida a partir de la Gran Encuesta Integrada de Hogares (GEIH). Esta clasificación permite distinguir siete logros educativos comparables durante todo el periodo: ninguno, básica primaria, básica secundaria, educación media, formación técnica profesional y tecnológica, universitaria y posgrado. Para cada logro se estudia la evolución de la remuneración mensual por trabajador y la remuneración por hora trabajada.
...
\textbf{Para construir una serie comparable, el informe usa una clasificación CINE 11 disponible para todo el periodo.} Esta clasificación no depende solo de la respuesta gruesa de nivel educativo. También usa el último grado o semestre aprobado y la información de título o diploma cuando está disponible. Por eso permite distinguir formación técnica profesional y tecnológica, universitaria y posgrado antes de 2021, aunque la respuesta original agrupaba esos niveles como superior o universitaria. También puede asignar a una persona al logro inmediatamente anterior cuando reporta haber cursado un nivel, pero no haber completado el ciclo correspondiente. El Cuadro \ref{tab:mapeo_logros_educativos} resume la correspondencia usada en la serie larga.
...
\toprule
Logro CINE 11 en la serie larga & Información usada antes de 2021 & Información usada desde 2021 \\
\midrule
...
Técnica profesional y tecnológica & Superior o universitaria, clasificada por CINE 11 como técnica o tecnológica & Técnica profesional o tecnológica \\
Universitaria & Superior o universitaria, clasificada por CINE 11 como universitaria & Universitaria \\
Posgrado & Superior o universitaria, clasificada por CINE 11 como posgrado & Especialización, maestría o doctorado \\
No determinado & No sabe, no informa o información insuficiente & No sabe, no informa o información insuficiente \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Nota: CINE 11 corresponde a la Clasificación Internacional Normalizada de la Educación 2011. La serie de remuneración excluye el grupo no determinado. Fuente: cálculos propios con GEIH del DANE.}
\end{table}

\subsection{Descomposición del crecimiento de la remuneración}

\textbf{El crecimiento de la remuneración promedio puede descomponerse en dos componentes.} La remuneración promedio de la población ocupada puede escribirse como un promedio ponderado de la remuneración de cada logro educativo. Sea \(g\) uno de los logros educativos CINE 11 usados en los cuadros de remuneración, \(r_{g,t}\) la remuneración del grupo \(g\) en el año \(t\), y \(s_{g,t}\) su peso relativo. Tanto la remuneración por trabajador como la remuneración por hora trabajada se pueden escribir como:
...
\textbf{La remuneración promedio aumenta con el logro educativo, pero no creció rápido dentro de cada logro.} En 2025, la remuneración mensual por trabajador fue de 900 mil pesos entre quienes no reportaron ningún logro educativo, 1,5 millones en educación media, 1,9 millones en formación técnica profesional y tecnológica, 3,5 millones en educación universitaria y 6,9 millones en posgrado. La remuneración por hora conserva el mismo orden: 5,0 mil pesos para ninguno, 7,5 mil en educación media, 9,8 mil en formación técnica profesional y tecnológica, 18,9 mil en educación universitaria y 37,6 mil en posgrado.

\textbf{El total creció más rápido que la remuneración de cada logro educativo porque cambió la composición de la población ocupada.} La remuneración mensual por trabajador del total pasó de 1,5 a 1,9 millones de pesos, con crecimiento anual de 1,6\%. Dentro de los logros educativos, el crecimiento mensual fue menor: ninguno, básica primaria y básica secundaria crecieron alrededor de 0,6\% o 0,7\% anual, educación media creció 0,4\%, formación técnica profesional y tecnológica cayó 0,1\%, educación universitaria cayó 0,6\% y posgrado se mantuvo prácticamente estable. La remuneración por hora del total creció 2,0\% anual, también por encima del crecimiento observado dentro de cada logro educativo.

\textbf{Las razones frente al logro de menor remuneración siguen siendo amplias, aunque se redujeron entre 2010 y 2025.} En 2025, la remuneración mensual de quienes alcanzaron educación universitaria fue cuatro veces la remuneración de quienes no reportaron ningún logro educativo. En posgrado, la razón fue de 7,8 veces. La remuneración por hora muestra una diferencia parecida: 3,8 veces para educación universitaria y 7,6 veces para posgrado.
...
\textbf{Los aumentos sostenidos de la remuneración de la población ocupada no podrán depender indefinidamente de un mayor logro educativo.} Estudiar más sigue asociado con acceder a empleos mejor remunerados. Sin embargo, la remuneración de quienes alcanzan educación universitaria cayó en términos reales y la remuneración de quienes alcanzan posgrado se mantuvo prácticamente estable. Por esa razón, una agenda de productividad no puede limitarse a que más trabajadores alcancen mayores logros educativos. También debe elevar la productividad y la remuneración dentro de cada logro educativo.
...
\textbf{La caída de la remuneración de quienes alcanzan educación universitaria es una señal de alerta.} La serie larga muestra una reducción real de la remuneración universitaria entre 2010 y 2025. La desagregación reciente muestra que quienes tienen maestría, doctorado, formación técnica o tecnológica presentaron aumentos reales en su remuneración entre 2021 y 2025. Este no fue el caso de quienes alcanzaron pregrado o especialización. El relativo estancamiento de la remuneración de quienes alcanzan el pregrado como máximo logro educativo debe ser objeto de futuras investigaciones.
