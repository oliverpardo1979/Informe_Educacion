...
\textbf{La distribución de la remuneración para quienes tienen pregrado universitario da indicios de diversidad en la calidad de los egresados.} La Figura \ref{fig:kernel_remuneracion_credenciales_superiores} compara las distribuciones de 2021 y 2025 para la remuneración para educación universitaria, especialización y maestría. En educación universitaria, los paneles mensuales muestran una concentración de ocupados cerca del salario mínimo y otra alrededor de la media. Esta distribución es compatible con diferencias en la calidad de los egresados, aunque más investigación se requiere para verificar esta hipótesis.
