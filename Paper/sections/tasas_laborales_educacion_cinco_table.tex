...
\begin{tablenotes}
\scriptsize
\item \textit{Nota:} La tasa de participación se calcula como PEA/PET, la tasa de ocupación como ocupados/PET, la tasa de desempleo como desocupados/PEA y la tasa de formalidad como ocupados que cotizan a pensión sobre ocupados con clasificación válida de cotización. Las tasas se reportan en porcentaje. La agregación de cinco grupos permite calcular las tasas sobre toda la población en edad de trabajar en 2010 y 2025. Fuente: cálculos propios con microdatos GEIH del DANE.
\end{tablenotes}
\end{threeparttable}
\end{table}
